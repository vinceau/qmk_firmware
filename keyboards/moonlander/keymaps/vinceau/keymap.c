...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    WEBUSB_PAIR,       KC_RGHT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
        ...
        KC_LCTL, KC_LGUI, A(KC_LSFT), KC_LALT, KC_LGUI,  LALT_T(KC_APP),    RCTL_T(KC_ESC),   KC_RALT,   KC_RCTL, KC_LBRC, KC_RBRC, MO(SYMB),
    ...
    [SYMB] = LAYOUT_moonlander(
        ...
        _______, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, _______,           _______, KC_UP,   _______, _______, _______, _______, KC_F12,
