...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        KC_GRV,             KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    WEBUSB_PAIR,        KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,
        ...
        KC_LCTL,            KC_LALT, KC_LGUI, XXXXXXX, KC_SPC,           TG(WIN),        TG(SYMB),             KC_RGUI, KC_RALT, KC_LBRC, KC_RBRC, MO(SYMB),
                                            KC_SPC,  KC_BSPC, MO(MDIA),           MO(MDIA),  MO(VIM),  KC_ENT
    ),
    ...
    [NUM] = LAYOUT_moonlander(
        ...
        _______, _______, _______, _______, _______, _______, _______,           _______, _______, KC_7,    KC_8,     KC_9,     KC_MINUS, KC_BSLS,
    ...
    [MDIA] = LAYOUT_moonlander(
        ...
        _______, _______, _______, KC_MS_U, _______, _______, _______,           _______, _______, _______, _______, _______, KC_MPLY, _______,
        _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______,           _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______, _______,
        _______, KC_SYSTEM_SLEEP, _______, _______, _______, _______,                     _______, KC_MUTE, _______, _______, _______, _______,
