...
[L0] = LAYOUT_all(
	...
	KC_LSFT, XXXX, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, RESET,
	KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, LT(L1, KC_SPC), KC_SPC, KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT),
