...
[L0] = LAYOUT_all(
	...
	KC_LSFT, XXXX, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, MO(L3),  // 15
	KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_SPC, LT(L2, KC_SPC), KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT),   // 11

// Number pad layer
[L1] = LAYOUT_all(
	____, ____, ____, ____, ____, ____, ____, ____, KC_EQUAL, KC_SLASH, KC_ASTERISK, ____, ____, ____, ____,
	...
	____, ____, ____, ____, ____, ____, ____, ____, KC_1, KC_2, KC_3, KC_ENTER, ____, ____, ____,
