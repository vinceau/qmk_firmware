...
// Base (Windows) layer - ANSI QWERTY
[BL] = LAYOUT_all(
	...
	KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, MO(SL), LT(VL, KC_SPC), KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT),   // 11

// Mac layer - Swap left GUI and left ALT for Mac
[ML] = LAYOUT_all(
	...
	____, KC_LALT, KC_LGUI, ____, ____, ____, KC_RGUI, KC_RALT, ____, ____, ____),
...
// Setup layer - Reset, Function keys, Media controls
[SL] = LAYOUT_all(
	...
	____, XXXX, KC_SYSTEM_SLEEP, ____, ____, ____, ____, ____, KC_AUDIO_MUTE, ____, ____, ____, ____, ____, RESET,
	____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____),
